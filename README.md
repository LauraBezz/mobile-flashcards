...
In this application every users can create a deck which can hold an unlimited number of cards.

You have two link in the nav, they are:
* Decks
* Add Deck

### Decks

There is the list of deck, every deck box show title and number of cards.
